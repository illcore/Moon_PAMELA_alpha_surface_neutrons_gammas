...
CheckFile1.open("Moon_surface_neutron.dat", std::ios::app);
...
CheckFile2.open("Moon_surface_gamma.dat", std::ios::app);
CheckFile2 << TrackID << " " << PosX << " " << PosY << " " << PosZ << " " << KineticEnergy << " " << ParticleName << " " << Volume->GetName() << " " << ProcessName << G4endl;
CheckFile2.close();
}
}
}
